...
export default function BurgerMenu({ className = '' }: BurgerMenuProps) {
  ...
  return (
    <div className={getContainerClasses()}>
      <nav className="flex h-full w-full items-center justify-evenly bg-background-burger">
        <a href="#accueil" className="flex items-center justify-center">
          <img src="/image/logo_black.svg" alt="Logo" className="h-8 w-auto" />
        </a>
        <NavLinks
          className="flex h-full items-center gap-1 font-sofia text-3xl text-primary"
          variant="burger menu"
